...
**This is the `swift3` branch of CleanroomConcurrency.** It uses **Swift 3.0** and **requires Xcode 8** to compile.
...
Once a device-based run destination has been selected, select the appropriate build scheme for the target platform: “CleanroomConcurrency-iOS”, “CleanroomConcurrency-macOS”, “CleanroomConcurrency-tvOS” or “CleanroomConcurrency-watchOS”.
...
Want to learn more about CleanroomConcurrency? Check out [the README](https://github.com/emaloney/CleanroomConcurrency/blob/swift3/README.md).
